...
step_length = 0.15;
step_amount = ceil(dist/step_length);
...
for i = 1:step_amount
   ...
   yaw = atan((working_spline(2,idx)-working_spline(2,idx-1))/(working_spline(1,idx)-working_spline(1,idx-1)));
   support  = [support; x_tmp, y_tmp+(-1)^i*0.1, yaw];
